...
Route::middleware(['auth', IsAdmin::class])->prefix('yonetim')->name('yonetim.')->group(function () {
    ...
    Route::resource('bannerlar', BannerController::class)->parameters([
        'bannerlar' => 'banner'
    ])->names('banners');
});
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('/favori-toggle', [PredictionController::class, 'toggleFavorite'])->name('favorites.toggle');
    Route::get('/favorilerim', [PredictionController::class, 'favorites'])->name('favorites.index');
});
