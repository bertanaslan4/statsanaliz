            ...
            <div class="col-lg-10">
                <div class="card shadow-sm border-0">
                    <div class="card-body p-5">
                        <h2 class="mb-4 font-weight-bold" style="color: #38bdf8;">Gizlilik Politikası ve KVKK Aydınlatma Metni</h2>
                        <p class="text-muted mb-4">Son Güncelleme: {{ date('d.m.Y') }}</p>

                        <h5 class="font-weight-bold mt-4">1. Veri Sorumlusu</h5>
                        ...
                        <h5 class="font-weight-bold mt-4">2. Toplanan Kişisel Veriler ve İşlenme Amacı</h5>
                        ...
                        <h5 class="font-weight-bold mt-4">3. Verilerin Üçüncü Kişilerle Paylaşımı</h5>
                        ...
                        <h5 class="font-weight-bold mt-4">4. Hesap ve Veri Silme Hakkı (Kritik)</h5>
                        ...
                        <h5 class="font-weight-bold mt-4">5. İletişim</h5>
